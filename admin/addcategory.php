    ...
    $uploadPath =  $uploadDirectory."/";
        ...
        if (! in_array($fileExtension,$fileExtensions)) {
          ...
          if ($didUpload) {
              ...
              $err=0;
              $featured=0;
              $query = "INSERT INTO `medicinecategory` values('$id','$name',$featured,'$fileExtension')";
  ...
  <body>
    ...
    <div class="mywrapper">
      ...
      <div class="main-panel">
        <div class="container">
          <h3 style="padding-bottom:20px; padding-top:40px">Add Medicine Category</h3>
          <button class="mybtn btn-blue" onclick="location.href='./viewcategory.php'">Manage Categories</button>
          <?php
          if(isset($err))
          {
            if($err==0)
